...
class Main:
    def __init__(self, number_heads, buffer):
        self.epsilon = 1
...
for test_number in range(3):
    ...
    BUFFER = 80
    BATCH_SIZE = 10
    m = Main(number_heads, BUFFER)
    x, reward_history, advisee_history, adviser_history = m.train_and_evaluate_agent(EPOCHS, TARGET_UPDATE, BATCH_SIZE)
